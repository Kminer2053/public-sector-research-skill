...
- HTML 본문은 데스크톱 17px/500 이상, 모바일 16px 이상, 행간 1.7 안팎으로 렌더링되는가?
- 외부 웹폰트 없이 운영체제의 한국어 시스템 글꼴로 또렷하게 표시되는가?
- 데스크톱 본문 폭을 충분히 사용하고, 목차가 본문을 과도하게 오른쪽으로 밀지 않는가?
- 1040px 이하에서는 목차가 상단형으로 전환되고, 760px 이하에서는 카드가 한 열로 표시되는가?
...
- 1920px·1440px·900px 폭, 키보드, 인쇄, JavaScript 비활성 상태에서 읽을 수 있는가?
